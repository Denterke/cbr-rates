...
return [
     ...
     */
    'intro_text' => <<<INTRO
API CBR documentation.
#Response structure
##Response without errors
In the case of a response from the server without errors, you will receive a variation of the two hundredth code.<br>
...
In case of an error response from the server, you will receive a code other than two hundred.<br>
An example is shown on the right
```json
{
    "status": "error",
